...
The posts in this blog consist of photos and writings about some of the trips I've taken. If I have a reliable network connection, I'll update the blog while traveling with a few pictures and a description about the trip. Later when I get home, I’ll add more content and any revisions I care to make.

I was previously posting my travel reports on Google’s Blogger.com, linked [here](https://tiburonboy.blogspot.com/). Blogger worked fine, except sometimes the formatting was a little tricky and didn’t render the way I was expecting. This new blog is hosted on GitHub and rendered with Quarto, which so far, seems to work just fine.
